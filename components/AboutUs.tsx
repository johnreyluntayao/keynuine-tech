...
export const AboutUs = ({
  ...
  return (
    <section id="about" className="relative place-items-center antialiased py-8 md:py-16 bg-gradient-to-b from-white to-darkblue-100 -mx-mobile-margin md:-mx-tablet-margin lg:-mx-laptop-margin">
      <motion.div
